        ...
        <div class="goods-info">
            ...
            <div class="goods-filters df">
                <div class="goods-counter">
                    ...
                    <input id="count" type="number" placeholder="1" value="1" min="1" max="99">
                    <span class="btn-counter _plus" onclick="increaseNumber();"></span>
                    <span class="btn-counter _minus" onclick="reduceNumber();"></span>
                </div>
                <a href="<?= \yii\helpers\Url::to(['cart/add', 'id' => $product->id, 'volume' => current($options)[0], 'volume-type' => key($options) ,'qty' => 1])?>" data-id="<?= $product->id ?>" data-volume="2" data-qty="1" data-volume-type="<?= key($options) ?>" class="btn btn-orange btn-goods add-to-cart">
                    <p>Купити</p>
                </a>
            </div>
